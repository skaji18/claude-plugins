...
```
/plugin install gantt@skaji18-plugins
```
...
After running `/gantt:init`, use the `open` command to view the chart:

```
/gantt:open ./gantt/gantt.yaml
```
